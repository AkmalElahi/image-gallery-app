...
import { selectwallpaperPopular, selectwallpaperLoading } from '../../redux/wallpapers/wallpaper.selector'
...
import { selectAlbumPopular, selectalbumLoading } from '../../redux/albums/albums.selector';
...
const PopularTab = ({ navigation, onScroll, getAlbums, getWallpapers, currentTab, wallpapers, albums, albumsLoading, wallpapersLoading }) => {
    ...
    const getData = () => {
        if (active === 'wallpaper') {
            getWallpapers({ type: 'popular', page: wapllpaperPage })
            return
        }
        if (active === 'album') {
            getAlbums({ type: 'popular', page: albumPage })
            return
        }
    ...
    return (
        ...
        <View style={{ flex: 1, backgroundColor: colors.background }}>
            ...
            {/* {console.log("ALBUM PAGE", albumPage, "WALLPAPER PAGE", wapllpaperPage, 'popular')} */}
